        ...
        <div class="card-item" v-bind:class="{ '-active' : isCardFlipped }">
          <div class="card-item__side -front">
            ...
            <div class="card-item__cover">
              <img
                  v-bind:src="'https://wallpaperaccess.com/full/869.jpg'" class="card-item__bg">
            </div>
          ...
          <div class="card-item__side -back">
            <div class="card-item__cover">
              <img
                  v-bind:src="'https://img.freepik.com/free-vector/pixel-art-city-background-blue-with-buildings-constructions-bridge-cloudy-sky-8bit-game_360488-551.jpg'" class="card-item__bg">
            </div>
